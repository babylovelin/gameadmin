    ...
    <div class="table" >
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>所有玩家</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="handle-box">
            ...
            <el-input v-model="select_word" placeholder="用户ID搜索" class="handle-input mr10"></el-input>
            <el-button type="primary" icon="search" @click="search(select_word)">搜索</el-button>
        </div>
        <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            <el-table-column type="selection" width="55"></el-table-column>
            <el-table-column prop="userid" label="玩家ID" sortable width="500">
            </el-table-column>
            <el-table-column prop="gems" label="房卡数" sortable >
            </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getData(){
                ...
                this.$http.post('superadmin/getallplayer', params).then((res) => {
                  // console.log(res);
                    this.allData = res.data.res;
                    this.total = this.allData.length;
                    this.tableData = res.data.res.slice(0,10);
