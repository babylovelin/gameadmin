    ...
    <div class="table" >
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>所有代理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="handle-box">
            ...
            <el-input v-model="select_word" placeholder="用户名搜索" class="handle-input mr10"></el-input>
            <el-button type="primary" icon="search" @click="search(select_word)">搜索</el-button>
        </div>
        <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            <el-table-column type="selection" width="55"></el-table-column>
            <el-table-column prop="username" label="代理手机号" sortable width="300">
            </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getData(){
                ...
                this.$http.post('superadmin/getallproxy', params).then((res) => {
