<template>
    <div class="table" >
        ...
        <div class="handle-box">
            ...
            <el-input v-model="select_word" placeholder="代理手机号搜索" class="handle-input mr10"></el-input>
            <el-button type="primary" icon="search" @click="search(select_word)">搜索</el-button>
        </div>
        <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            <el-table-column type="selection" width="55"></el-table-column>
            <el-table-column prop="proxyname" label="代理手机号" sortable width="300">
            </el-table-column>
            <el-table-column prop="time" label="时间" sortable >
            </el-table-column>
            <el-table-column prop="cny" label="人民币" sortable >
            </el-table-column>
            <el-table-column prop="roomcard" label="充值房卡数" sortable >
            </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getData(){
                ...
                this.$http.post('superadmin/getallproxychargeforself', params).then((res) => {
                  // console.log(res);
              ...
              if (txt == "") {
                ...
                // var searchbykey = function (txt) {
                  ...
                  for(var i = 0; i < x.length; i++){
                      var obj = x[i];
                          if(obj['proxyname'].toString().indexOf(txt) != -1) {
                              result.push(obj);
                          }
                  }
                  this.allData = result
